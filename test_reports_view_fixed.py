#!/usr/bin/env python3
"""
Test script for the Reports View (Fixed version).
"""
...
def test_reports_view():
    ...
    # Create a dummy main window for the controller
    dummy_window = QMainWindow()
    
    # Create main controller with the dummy window
    main_controller = MainController(main_window=dummy_window)
    
    # Create test window
    window = QMainWindow()
    window.setWindowTitle("Test - Reports View (Fixed)")
